...
public class PigOpClauseImpl extends PigPsiElementImpl implements PigOpClause {
  ...
  @Override
  @Nullable
  public PigRmfClause getRmfClause() {
    return findChildByClass(PigRmfClause.class);
  }
