...
public interface PigTypes {
  ...
  IElementType PIG_RMF_CLAUSE = new PigElementType("PIG_RMF_CLAUSE");
  ...
  IElementType PIG_FILENAME = new PigTokenType("FILENAME");
  ...
  IElementType PIG_RMF = new PigTokenType("RMF");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      else if (type == PIG_RMF_CLAUSE) {
        return new PigRmfClauseImpl(node);
      }
